...
verifier::verifier(const char *username)
{
...
int verifier::verifyFace(IplImage *faceMain)
{
    ...
    CvFileStorage * fileStorage;//clean
    CvMat *maceFilterUser;//clean
    CvMat *lbpModel;//clean
